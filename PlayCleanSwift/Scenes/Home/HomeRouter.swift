...
{
  func routeToFoodDetail(foodName: String)
}
...
class HomeRouter: NSObject, HomeRoutingLogic, HomeDataPassing
{
  ...
  func routeToFoodDetail(foodName: String) {
    let storyboard = UIStoryboard(name: "Main", bundle: nil)
    let destinationVC = storyboard.instantiateViewController(withIdentifier: "FOOD_DETAIL") as! FoodDetailViewController
    
    destinationVC.foodName = foodName
    
    navigateToFoodDetail(source: viewController!, destination: destinationVC)
  }
